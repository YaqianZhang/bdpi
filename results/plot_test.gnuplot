...
lunarlander_ppi = "<(python3 ../avg_stats.py 0 '' log-parallel-lunarlander-rp-16critics-er256-epochs20x16-qloops4-?)"
lunarlander_aabdqn = "<(python3 ../avg_stats.py 0 '' log-bootstrapped-lunarlander-16critics-er256-epochs20x16-qloops4-?)"
lunarlander_bdqn_opt = "<(python3 ../avg_stats.py 0 '' log-bootstrapped-lunarlander-16critics-er256-epochs20x1-qloops1-?)"
lunarlander_mimic = "<(python3 ../avg_stats.py 0 '' log-parallel-lunarlander-mimic-16critics-er256-epochs20x16-qloops4-?)"
